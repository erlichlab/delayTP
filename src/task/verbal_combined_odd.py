...
def verbal_odd(var,doo,mouse,myPoints,dbc):
    ...
    sql.w_after_verbalCombined_nq(dbc,var,id,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay) # record the final info of this whole experiment in sessions_end table in database
